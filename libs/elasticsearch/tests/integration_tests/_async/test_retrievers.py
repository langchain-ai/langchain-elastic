...
class TestElasticsearchRetriever:
    ...
    @pytest.mark.asyncio
    async def test_init_url(self, index_name: str) -> None:
    ...
    @pytest.mark.asyncio
    async def test_multiple_index_and_content_fields(
        self, es_client: AsyncElasticsearch, index_name: str
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_fail_neither_content_field_nor_mapper(
        self, es_client: AsyncElasticsearch
    ) -> None:
